...
public final class Icons {
    ...
    private static final String SERVER =
            "M4,1H20A2,2 0 0,1 22,3V7A2,2 0 0,1 20,9H4A2,2 0 0,1 2,7V3A2,2 0 0,1 4,1M4,"
                    + "3V7H20V3H4M4,11H20A2,2 0 0,1 22,13V17A2,2 0 0,1 20,19H4A2,2 0 0,1 "
                    + "2,17V13A2,2 0 0,1 4,11M4,13V17H20V13H4M9,5H10V6H9V5M9,15H10V16H9V15"
                    + "M5,5H7V6H5V5M5,15H7V16H5V15Z";
